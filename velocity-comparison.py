...
def fetch_and_process_data(station, duration, local_velocity_data):
    ...
    # Print the correction factor and the formula
    print(f"Correction Factor: {correction_factor}")
    print(f"Formula: corrected_local_velocity = local_velocity * {correction_factor}")
    ...
    import ace_tools as tools; tools.display_dataframe_to_user(name="Velocity Data Comparison", dataframe=df)
